...
public class PersonTest {
	...
	public void setup() {
		...
		dummyPerson2 = new Person("Tests", "testsss", "applicationTest2@gmail.com", "938472819", "applicationTest2","då", roleRepo.findByName("recruit"));
	...
	public void invalidFirstNameTest() {
		saveInvalidPerson(null,"testaryy","applicationTest1@gmail.com","9443898491","applicationTest1","då", roleRepo.findByName("applicant"));
		
	}
	@Test(expected =DataIntegrityViolationException.class)
	public void invalidLastNameTest() {
		saveInvalidPerson("testy","null","applicationTest1@gmail.com","9443898491","applicationTest1","då", roleRepo.findByName("applicant"));
	}
	@Test(expected =ConstraintViolationException.class)
	public void invalidLastNameblankTest() {
		saveInvalidPerson("testy","","applicationTest1@gmail.com","9443898491","applicationTest1","då", roleRepo.findByName("applicant"));
	}
	private void saveInvalidPerson(String firstName, String lastName, String email, String ssn, String username, String password, Role role) {
