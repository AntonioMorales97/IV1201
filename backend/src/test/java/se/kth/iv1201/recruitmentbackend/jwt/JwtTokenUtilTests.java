...
import se.kth.iv1201.recruitmentbackend.security.MyUserDetails;
...
public class JwtTokenUtilTests {
	...
	public void validateTokenFailTest() {
		UserDetails user=register(dummyPerson);
		PersonDTO failPerson= new PersonDTO("taget", "taget","jwtFail@gmail.com", "9901939482", "jwtFail", "Detkanske");
